...
elementm3 = UIMenu("black", "white", "M1", canvas, windowelements1, menu_stack, scroller)
windowelements = [elementm1, elementm2, elementm3]  # 2

element3 = UIMenu("black", "white", "Menushka", canvas,  windowelements, menu_stack, scroller)
